...
time.sleep(6)
driver.find_element_by_xpath("/html/body/div[1]/div[1]/div[1]/div[8]/ul[1]/li[1]/a/span").click()
time.sleep(6)
driver.find_element_by_xpath("/html/body/div[1]/div[2]/div[2]/div/div/div/table/tbody/tr[1]/td[2]").click()
time.sleep(6)
driver.find_element_by_xpath("/html/body/div[1]/div[2]/div[2]/div/div/header/button[6]").click()
time.sleep(4)